...
public class Agregar_mesa extends javax.swing.JFrame {
    ...
    public Agregar_mesa() {
        initComponents();
        setDefaultCloseOperation(Agregar_mesa.DISPOSE_ON_CLOSE);
    }
    ...
    if(texto.equals("----------")){
        JOptionPane.showMessageDialog(this, "Por favor, selecciona ubicacion", "Error", JOptionPane.ERROR_MESSAGE);
        return;
    }
    ...
    if (elec.buscar_mesa(texto, valor)) {
        JOptionPane.showMessageDialog(this, "El " + texto + " ya está asignada a " + valor,  "Error", JOptionPane.ERROR_MESSAGE);
        return;
    }
