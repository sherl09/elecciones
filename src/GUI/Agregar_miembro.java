...
public class Agregar_miembro extends javax.swing.JFrame {
    /** Creates new form Agregar */
    private Mesa mesa;
    public Agregar_miembro() {
        initComponents();
        setDefaultCloseOperation(Agregar_miembro.DISPOSE_ON_CLOSE);
    }
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(Tipo_ComboBox, javax.swing.GroupLayout.Alignment.LEADING, 0, 278, Short.MAX_VALUE)
                            ...
                            .addComponent(DNI_TextField, javax.swing.GroupLayout.Alignment.LEADING)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(135, 135, 135)
                        .addComponent(guardar_Button, javax.swing.GroupLayout.PREFERRED_SIZE, 135, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(30, 30, 30)
    ...
    Gestion_votos.Miembro miembro=new Gestion_votos.Miembro(texto,texto2,texto3,valor);
    mesa.agregarMiembro(miembro);
    this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Agregar_miembro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Agregar_miembro().setVisible(true);
            }
        });
    }
